...
class Daapavg(OWWidget):
    name="Daapavg analysis"
    description= 'Do a Daap analysis on the selected corpus and output the average'
    ...
    def inputAnalysis(self, corpus):
        ...
        if self.corpus is None:
            ...
            for msgId in range(0,len(self.corpus.metas)):
                ...
                averageWeights= np.mean(averageWeights)
